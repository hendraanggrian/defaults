...
infix fun Defaults.Companion.file(file: File): Defaults<*> = DefaultsPropertiesFile(file)

private class DefaultsPropertiesFile(private val file: File) :
    Defaults<DefaultsPropertiesFile.Editor> {
